...
export const mockDetailsJson: GetResponse<GetByIdResponseBody> = {
  ...
  result: {
    ...
    description:
      "\u003Cp\u003EThe most stylish and intriguing screen version of Sherlock Holmes and doctor Watson adventures is also well-known as a show whose creators love to tease their fans with painful hiatuses and criminally beautiful special episodes. \u003C/p\u003E\r\n\u003Ch3\u003ETrivia\u003C/h3\u003E \r\n\u003Cp\u003EA veteran of Afghan war is suffering from PTSD and urgently needs to find a new flatmate. His friend introduces him to a possible companion - mister Sherlock Holmes, self-proclaimed genius, high-functioning sociopath and private detective... In the meantime, Scotland Yard tries to find a serial killer who is terrorizing London and fails again and again. Great music, stylish visual effects, all kind of gadgets and other gifts of the twenty first century, outstanding performances of Benedict Cumberbatch, Martin Freeman and Andrew Scott - that's what makes this TV-show so unique. \u003C/p\u003E\r\n\u003Cp\u003ESo, are you SHERLOCKed?.. \u003C/p\u003E",
    totalSeasons: 4,
    ...
    year: 2010,
    kinopoiskId: 502838,
    kinopoiskRating: 8.858,
    kinopoiskVoted: 611936,
    kinopoiskUrl: 'http://www.kinopoisk.ru/film/502838/',
    tvrageId: 23433,
    imdbId: 1475582,
    imdbRating: 9.1,
    imdbVoted: 972598,
    ...
    watching: 412479,
    watchingTotal: 840580,
    voted: 224264,
    rating: 4.73,
    runtime: 90,
    runtimeTotal: '22 hours 7 minutes',
    images: [
